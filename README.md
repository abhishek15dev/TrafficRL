...
This project demonstrates traffic signal control at a single intersection using **Reinforcement Learning (Proximal Policy Optimization – PPO)** and compares it with a **fixed-time baseline controller** using the **SUMO traffic simulator**.

The objective is to **reduce traffic congestion** by dynamically controlling traffic lights based on real-time queue lengths.
...
- Performance demonstrated via side-by-side visual comparison
...
**Abhishek**  
1st Year Undergraduate Student, IIT Roorkee  
Project: *Traffic Signal Optimization using Reinforcement Learning*
